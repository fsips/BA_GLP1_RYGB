...
si_trans_out_quick_1= si1_quick * k_si_trans_1_2; 
...
si_trans_out_slow_1= si1_slow * k_si_trans_1_2; 
...
si_trans_in_quick_1= st_trans_3_quick * (1-RYGB);
si_trans_in_quick_2= st_trans_1_quick * RYGB + si1_quick * k_si_trans_1_2;
si_trans_in_quick_3= si2_quick * k_si_trans_2_3; 
si_trans_in_quick_4= si3_quick * k_si_trans_3_4; 
...
si_trans_in_slow_1= st_trans_3_slow * (1-RYGB);
si_trans_in_slow_2= st_trans_1_slow * RYGB + si1_slow * k_si_trans_1_2;
...
GLP1_b1              = max(si1_sc + si1_su  - si1_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 1 *int_dist).^2 / V_GLP1;
GLP1_b2              = max(si2_sc + si2_su  - si2_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 2 *int_dist).^2 / V_GLP1;
GLP1_b3              = max(si3_sc + si3_su  - si3_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 3 *int_dist).^2 / V_GLP1;
GLP1_b4              = max(si4_sc + si4_su  - si4_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 4 *int_dist).^2 / V_GLP1;
GLP1_b5              = max(si5_sc + si5_su  - si5_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 5 *int_dist).^2 / V_GLP1;
GLP1_b6              = max(si6_sc + si6_su  - si6_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 6 *int_dist).^2 / V_GLP1;
GLP1_b7              = max(si7_sc + si7_su  - si7_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 7 *int_dist).^2 / V_GLP1;
GLP1_b8              = max(si8_sc + si8_su  - si8_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 8 *int_dist).^2 / V_GLP1;
GLP1_b9              = max(si9_sc + si9_su  - si9_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 9 *int_dist).^2 / V_GLP1;
GLP1_b10             = max(si10_sc+ si10_su - si10_ref, 0) .* k_BAGLP1*(GLP1_xa+GLP1_xb* 10 *int_dist).^2 / V_GLP1;
GLP1_ba              = GLP1_b1 + GLP1_b2 + GLP1_b3 + GLP1_b4 + GLP1_b5 ...
